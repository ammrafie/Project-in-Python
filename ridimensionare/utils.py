"""
This module contains a set of utilities that are helpful for working with images,
which are needed to actually apply the seam carving algorithm to images.
