"""
Implementation of finding the lowest-energy seam in an image. Here we 
reconstruct the entire seam from the top to the bottom of the image.

Running this module in isolation, the lowest-energy seam will be visualized:
...
def compute_vertical_seam(energy_data):
    ...
    Beside storing and finding the lowest-energy value of any seam, it will also
    store back pointers used to reconstruct the lowest-energy seam.
    At the end, it will return a list of x-coordinates where you would have
